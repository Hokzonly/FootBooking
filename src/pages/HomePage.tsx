...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
      ...
      <div className="mb-6 sm:mb-8" ref={academiesRef} id="academies-section">
      ...
      <motion.section
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
        className="mt-16 sm:mt-20 bg-gradient-to-br from-green-50 to-white rounded-2xl p-8 sm:p-12"
      >
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          className="text-center mb-12"
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Suivez-nous</h2>
          <p className="text-lg text-gray-600">Restez connecté avec notre communauté football</p>
        </motion.div>
        ...
        <div className="flex justify-center space-x-8 sm:space-x-12">
          ...
          >
            ...
            <span className="text-sm text-gray-600">@footbooking</span>
          </motion.a>
